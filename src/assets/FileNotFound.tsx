const FileNotFound = ({ height = 100, width = 100 }: { height?: number; width?: number }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve" x={0} y={0} viewBox="0 0 400 400" height={height} width={width}>
      <path d="M49.4 311.2 28.2 104.3l68 7 4-20.6 74.5 7.6 9.3 33.5 181.3 18.4-53.7 186 .2 1.7-1.9-.2z" className="fill-[#393f4f]" />
      <path
